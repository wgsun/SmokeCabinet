...
//                if (uuid == null) {
//                    final SharedPreferences prefs = CabinetUtils.getApp().getSharedPreferences(PREFS_FILE, 0);
...
//
//                    } else {
//                        final String androidId = Settings.Secure.getString(CabinetUtils.getApp().getContentResolver(), Settings.Secure.ANDROID_ID);
//                        try {
//                            if (!"9774d56d682e549c".equals(androidId)) {
//                                uuid = UUID.nameUUIDFromBytes(androidId.getBytes());
//                            } else {
//                                final String deviceId = ((TelephonyManager) CabinetUtils.getApp().getSystemService(Context.TELEPHONY_SERVICE)).getDeviceId();
